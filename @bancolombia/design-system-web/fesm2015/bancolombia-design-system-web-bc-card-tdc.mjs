...
class FormatAmountPipe {
    ...
    transform(value) {
        ...
        return {
            int: (_a = (this.currencyPipe.transform(Math.trunc(+int), 'CUP', '', '0.0-0'))) === null || _a === void 0 ? void 0 : _a.split(',').join('.'),
            decimal: decimal || '00'
        };
    }
}
...
class BcCardTdcComponent {
    ...
    ngOnChanges(changes) {
        var _a;
        this.bcCardTdcBehavior.radioGroupName = (_a = changes.radioGroupName) === null || _a === void 0 ? void 0 : _a.currentValue;
    }
    /**
    ...
    selectCard() {
        ...
        setTimeout(() => {
            this.selectedEmitter.emit(Object.assign(Object.assign({}, cardInfo), { selected: this.bcCardTdcBehavior.isSelected }));
        });
    }
    /**
